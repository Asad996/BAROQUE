...
var Offcanvas = React13.forwardRef(({
  ...
  const modalManager = (0, import_react10.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const {
    onToggle
  } = (0, import_react10.useContext)(NavbarContext_default) || {};
  const [showOffcanvas, setShowOffcanvas] = (0, import_react10.useState)(false);
  ...
  const renderBackdrop = (0, import_react10.useCallback)((backdropProps) => (0, import_jsx_runtime15.jsx)("div", {
    ...backdropProps,
...
//# sourceMappingURL=chunk-DHHUNCPT.js.map
